                            ...
                            <div className="d-flex flex-column h-100 py-0 py-xl-4">
                                ...
                                {company_profile_dataa && 
                                    <Link to="/">
                                        <span className="logo-lg">
                                            ...
                                            <span className='c_profile_name'>{company_profile_dataa && company_profile_dataa[0]?.company_name}</span>
                                ...
                                <div className="card my-auto overflow-hidden">
                                        <div className="row g-0">
                                            <div className="col-lg-6">
                                                <div className="p-lg-5 p-4">
                                                    <div className="text-center">
                                                        ...
                                                        <p className="text-muted mt-2">Sign in to continue to {company_profile_dataa && company_profile_dataa[0]?.company_name}.</p>
                                                    </div>
                                            ...
                                            <div className="col-lg-6">
                                                <div className="d-flex h-100 bg-auth align-items-end" style={{backgroundImage : "url('assets/images/rangaimg.png')", marginTop:"50px"}}>
                                                    <div className="p-lg-5 p-4">
